...

{
    new Patient
    {
        ...
        //Age = CalculateAge(new DateOnly(1985, 5, 10)),
        ContactNo = "+880-171-1234567",
    ...
    new Patient
    {
        ...
        Gender = Genders.Male,
        //Age = CalculateAge(new DateOnly(1990, 8, 15)),
    ...
    new Patient
    {
        ...
        Gender = Genders.Female,
        //Age = CalculateAge(new DateOnly(1976, 3, 20)),
        ...
        Status = "Active"
            ...
            new Patient
            {
                ...
                Gender = Genders.Male,
                //Age = CalculateAge(new DateOnly(1982, 10, 5)),
           ...
           new Patient
            {
                ...
                Gender = Genders.Female,
                //Age = CalculateAge(new DateOnly(1995, 7, 15)),
             ...
             new Patient
            {
                ...
                Gender = Genders.Male,
                //Age = CalculateAge(new DateOnly(1988, 12, 25)),
